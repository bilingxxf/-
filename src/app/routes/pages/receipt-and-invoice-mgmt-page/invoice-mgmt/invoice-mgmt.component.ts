...
@Component({
  selector: 'app-invoice-mgmt',
  templateUrl: './invoice-mgmt.component.html',
})
export class InvoiceMgmtComponent implements OnInit {
    ...
    openCreateModal() {
        this.modal.create({
            nzTitle: `添加开票记录`,
            nzContent: InvoiceCreateModalComponent,
            nzWidth: 600,
