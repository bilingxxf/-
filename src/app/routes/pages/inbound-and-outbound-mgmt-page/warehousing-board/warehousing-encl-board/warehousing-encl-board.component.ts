...
@Component({
  selector: 'app-warehousing-encl-board',
  templateUrl: './warehousing-encl-board.component.html',
})
export class WarehousingEnclBoardComponent implements OnInit {
  ...
  async getData() {
        ...
        this.sum = await this.warehousingService.getEnclSum(this.monomerId)
  }
