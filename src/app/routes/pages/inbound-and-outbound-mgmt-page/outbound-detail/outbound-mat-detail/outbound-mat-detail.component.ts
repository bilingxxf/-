...
import {
    FactoryLogisticsDTO
} from '@core/logistics/factory-logistics-dto'
import {
    CargoListService
} from '@core/cargo-list/cargo-list.service'
import {
    NzModalService
} from 'ng-zorro-antd'
import {
    CargoListDetailModalComponent
} from '../../../cargo-list-mgmt-page/cargo-list-detail-modal/cargo-list-detail-modal.component'
import * as moment from 'moment'
import {
    UtilService
} from '@core/util/util.service'

@Component({
    selector: 'app-outbound-mat-detail',
    templateUrl: './outbound-mat-detail.component.html',
})
export class OutboundMatDetailComponent implements OnInit {
