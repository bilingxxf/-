...
@Component({
  selector: 'app-fix-static-structure',
  templateUrl: './fix-static-structure.component.html',
})
export class FixStaticStructureComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.dto.productType = ProductTypes.结构
        this.dto.scanType = ScanTypes.安装
        this.getData()
        this.getTotal()
    }
