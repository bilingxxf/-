...
@Component({
    selector: 'app-board-encl',
    templateUrl: './board-encl.component.html',
})
export class BoardEnclComponent implements OnInit {
    ...
    async getData() {
        ...
        try {
            ...
            this.data = response.data.map(o => {
                ...
                return {
                    content: `${o.name} ${o.modelNum} ${o.useArea} ${this.finishType === 1 ? o.receiptQuantity : o.setupQuantity}/${o.totalQuantity}`,
                    areas: [{
                        color,
                        percent: 1
                    }]
