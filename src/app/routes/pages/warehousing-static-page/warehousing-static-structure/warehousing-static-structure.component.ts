...
@Component({
  selector: 'app-warehousing-static-structure',
  templateUrl: './warehousing-static-structure.component.html',
})
export class WarehousingStaticStructureComponent implements OnInit {
