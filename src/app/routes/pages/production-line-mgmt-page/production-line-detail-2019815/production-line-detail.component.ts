...
export class ProductionLineDetail implements OnInit {
    ...
    handleOk() {
      ...
      if( this.validateForm.controls.userId.value) {
        this.roleService.addRoleProduct(this.addMemberForm.userId, this.addMemberForm.productLineId, this.addMemberForm.styleId).then(res => {
          if(res) {
