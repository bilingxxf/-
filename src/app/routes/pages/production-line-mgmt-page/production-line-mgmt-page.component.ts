...
@Component({
  selector: 'app-production-line-mgmt-page',
  templateUrl: './production-line-mgmt-page.component.html',
})
export class ProductionLineMgmtPageComponent implements OnInit {
    isVisible: boolean = false;
    addMemberForm: any = {}
    styleList: any = []
    userList: any = []
    companyId: number
    // finalAssemblyUser: any
    finalAssemblyUser: any= [{
        supplierId: 0,
        name: '直发工地流程'
    }, {
